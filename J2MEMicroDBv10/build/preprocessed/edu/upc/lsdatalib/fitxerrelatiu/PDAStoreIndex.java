 ...
 * L'identificador de les entrades és la posició lògica dels PDAStoreables al PDAStore.<br/>
 * Les entrades de l'índex relacionen l'adreça física i lògica d'un PDAStoreable dins del PDAStore 
 * i contenen la informació necessària per guardar i recuperar els PDAStoreables.
...
abstract class PDAStoreIndex {
	...
	/**
	 * Retorna l'entrada de l'índex identificada pel paràmetre índex.
	 * @param index Identificador de l'entrada que es vol obtenir (posició lògica del PDAStoreable associat a aquesta entrada).
	...
	/**
	 * Actualitza una entrada de l'índex.
	...
	/**
	 * Esborra l'entrada de l'índex identificada pel paràmetre índex.
	 * @param index Identificador de l'entrada a esborrar (posició lògica del PDAStoreable associat a aquesta entrada).
