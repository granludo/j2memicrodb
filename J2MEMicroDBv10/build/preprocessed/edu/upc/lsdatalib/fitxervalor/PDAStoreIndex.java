 ...
 * L'identificador de les entrades és l'etiqueta dels PDAStoreables al PDAStore, i aquesta és única.
 * És a dir, no pot haver més d'una entrada amb la mateixa etiqueta.<br/>
...
abstract class PDAStoreIndex {
	...
	/**
	 * Retorna l'entrada de l'índex identificada pel paràmetre label.
	 * @param label String que identifica l'entrada a l'índex.
	...
	/**
	 * Esborra l'entrada de l'índex identificada pel paràmetre label.
	 * @param label String que identifica l'entrada a l'índex.
