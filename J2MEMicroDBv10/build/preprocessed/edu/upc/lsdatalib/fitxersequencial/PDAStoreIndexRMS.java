...
public class PDAStoreIndexRMS extends PDAStoreIndexVector {
	...
	{		
		...
		catch (RecordStoreNotFoundException nf) //L'índex no existeix, fem un de nou
		{
			...
			{
				throw new PDAException(86);
			}
			catch (RecordStoreNotFoundException e)
			{
				throw new PDAException(87);
			}
			catch (RecordStoreException e)
			{
				throw new PDAException(88);
			}			
		}
		catch (RecordStoreFullException e)
		{
	...
	private void copyIndexToMemory() throws PDAException
	{
		...
		try
		{
			...
			while(re.hasNextElement())
			{
				...
				if(!exit) throw new PDAException(89);
			}
		}
		catch (RecordStoreNotOpenException e)
		{
			throw new PDAException(90);
		}
		catch (InvalidRecordIDException e)
		{
			throw new PDAException(91);
		}
		catch (RecordStoreException e)
		{
			throw new PDAException(92);
		}		
	}
	...
	{		
		...
		{
			throw new PDAException(93);
		}
		catch (RecordStoreException e)
		{
			throw new PDAException(94);
		}		
	...
	protected void closeIndex() throws PDAException
	{
		...
		{
			throw new PDAException(96);
		}
		catch (RecordStoreException e)
		{
			throw new PDAException(97);
		}
	}
	...
	protected void deleteIndex() throws PDAException
	{
		...
		{
			throw new PDAException(98);
		}
		catch (RecordStoreException e)
		{
			throw new PDAException(99);
		}
	}
	...
	protected String printToString()
	{
		...
		for(int i=0; i<size; i++)
		{
			...
			s += "["+r.getIndex()+"],["+r.getPos()+"],["+r.getSize()+"],["+r.getClassName()+"],["+r.getNext()+"]\n";
		}
		return "\nPDAStoreIndexVector (índex a memòria):\n[index PosicioLogica i identificador],[pos PosicioFisica],[size Tamany PDAStoreable],[className] [next]\n"+s;
	}
}
