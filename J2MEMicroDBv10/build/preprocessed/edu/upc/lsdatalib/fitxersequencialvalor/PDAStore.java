...
public abstract class PDAStore
{
	 ...
	 * @param label Etiqueta identificadora de l'objecte a escriure dins el fitxer.
	 */
	...
	/**
	 * Modifica la informació del PDAStoreable que es troba a la posició que s'està tractant.
	...
	/**
	 * Es posiciona al primer PDAStoreable identificat per l'etiqueta passada per paràmetre.
	 * @param label Etiqueta identificadora de l'objecte a buscar dins el fitxer.
	 * @return Cert si l'operació ha tingut éxit. Fals en cas contrari.
	 */
	public abstract boolean seek(String label) throws PDAException; 	
}
