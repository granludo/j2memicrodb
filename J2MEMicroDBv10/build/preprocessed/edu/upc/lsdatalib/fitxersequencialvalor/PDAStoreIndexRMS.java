...
public class PDAStoreIndexRMS extends PDAStoreIndexVector {
	...
	/** RecordStore que usa el PDAStoreIndexRMS per a guardar la seva informació al dispositiu */
	...
	{		
		...
		catch (RecordStoreNotFoundException nf) //L'índex no existeix, fem un de nou
		{
			...
			{
				throw new PDAException(132);
			}
			catch (RecordStoreNotFoundException e)
			{
				throw new PDAException(133);
			}
			catch (RecordStoreException e)
			{
				throw new PDAException(134);
			}			
		}
		catch (RecordStoreFullException e)
		{
	...
	/**
	 * Recupera l'índex de disc a memòria
	 * @throws PDAException 
	 */
	private void copyIndexToMemory() throws PDAException
	{
		...
		try
		{
			...
			while(re.hasNextElement())
			{
				...
				if(!exit) throw new PDAException(135);
			}
		}
		catch (RecordStoreNotOpenException e)
		{
			throw new PDAException(136);
		}
		catch (InvalidRecordIDException e)
		{
			throw new PDAException(137);
		}
		catch (RecordStoreException e)
		{
			throw new PDAException(138);
		}		
	}
	...
	{		
		...
		{
			throw new PDAException(139);
		}
		catch (RecordStoreException e)
		{
			throw new PDAException(140);
		}		
	...
	protected void closeIndex() throws PDAException
	{
		...
		{
			throw new PDAException(142);
		}
		catch (RecordStoreException e)
		{
			throw new PDAException(143);
		}
	}
	...
	protected void deleteIndex() throws PDAException
	{
		...
		{
			throw new PDAException(144);
		}
		catch (RecordStoreException e)
		{
			throw new PDAException(145);
		}
	}
	...
	protected String printToString()
	{
		...
		for(int i=0; i<size; i++)
		{
			...
			s += "["+r.getLabel()+"],["+r.getPos()+"],["+r.getSize()+"],["+r.getClassName()+"],["+r.getNext()+"]\n";
		}
		return "\nPDAStoreIndex (índex):\n[label Etiqueta i identificadornounic],[pos PosicioFisica],[size Tamany PDAStoreable],[className],[next]\n"+s;
	}
}
