 ...
 * @author Pelsman
 */
public class MobileBDRemoteMidlet extends MIDlet implements CommandListener {
    
    /** Creates a new instance of MobileBDRemoteMidlet */
    public MobileBDRemoteMidlet() {
        initialize();
    }
    
    private final String ip = "127.0.0.1:8080";
    //private final String ip = "127.0.0.1";
    private final String bdd = "proves";
    private final int sgbd = 0;
    private final String user = "root";
    private final String pwd = "ROOT";
    
    private MobileHTTPConnection mc = null;
        ...
        if (displayable == FPrincipal) {//GEN-BEGIN:MVDCABody
            if (command == enviar) {//GEN-END:MVDCABody
                ...
                try{
                    ...
                    while(!mc.DBOpened()){}
                    int ticket = mc.DBStatement(TSQL.getString());
...
//GEN-LINE:MVDInitInit
    ...
    /** This method returns instance for TSQL component and should be called instead of accessing TSQL field directly.//GEN-BEGIN:MVDGetBegin3
     * @return Instance for TSQL component
     */
    public TextField get_TSQL() {
        if (TSQL == null) {//GEN-END:MVDGetBegin3
            // Insert pre-init code here
            TSQL = new TextField("Sql Statement:", "select * from prova1;", 120, TextField.ANY);//GEN-LINE:MVDGetInit3
            // Insert post-init code here
    ...
    public void startApp() {
        ...
        mc = new MobileHTTPConnection(ip,bdd,sgbd,user,pwd);
