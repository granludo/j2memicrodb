...
{
	/** Posició lògica del PDAStoreable i identificador de l'entrada de l'índex. */
	private long index;
	
	/** Posició física del PDAStoreable. */
	private long pos;
	...
	/** Posició física a l'índex de l'entrada següent. */
	private int next;
	 ...
	 * @param pindex	Posició lògica del PDAStoreable del qual es crea l'entrada a l'índex i identificador de l'entrada.
	 ...
	 * @return Cert si els PDAStoreRecordIndex són iguals. Fals en cas contrari.
	 * */
	...
	{
		String data = String.valueOf(this.index)+"|"+String.valueOf(this.pos)+"|"+String.valueOf(this.size)+"|"+this.className+"|"+this.next;
	...
	/**
	 * Actualitza next amb el valor passat per paràmetre.
	 */		
