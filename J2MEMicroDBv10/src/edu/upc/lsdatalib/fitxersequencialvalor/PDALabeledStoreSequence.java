...
/**
 * Classe que implementa el FITXER SEQÜENCIAL PER VALOR.
...
public class PDALabeledStoreSequence extends PDAStore {
	 ...
	 * Crea un índex sobre el PDALabeledStoreSequence. 
	 * @throws PDAException 
	 * */
	...
	/**
	 * Tanca el PDALabeledStoreSequence i salva l'índex.
	 * @throws PDAException 
	 */
	...
	/**
	 * Esborra el PDALabeledStoreSequence i el seu índex associat.
	 * @throws PDAException 
	 */
	...
	/**
	 * Guarda el contingut de l'índex a memòria (PDAStoreIndexVector) al disc (PDALabeledStoreSequence)<br/>
	...
	/**
	 * Mètode privat de la desenvolupadora per fer-lo servir a mode d'ajuda durant la creació de l'API. Obté el contingut del PDALabeledStoreSequence en un Vector.
	...
	/**
	 * Mètode de la desenvolupadora per fer-lo servir a mode d'ajuda durant la creació de l'API. Obté el contingut del PDALabeledStoreSequence en un String.
