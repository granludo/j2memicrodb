 ...
 */
package edu.upc.lsdatalib.utilsfitxer;
 ...
 * &nbsp;&nbsp;&nbsp;&nbsp;- <i>clau</i> és un enter. En el cas de les excepcions, la clau és el codi de l'excepció.<br/>
 * &nbsp;&nbsp;&nbsp;&nbsp;- <i>missatge</i> és una cadena. En el cas de constants de les excepcions, el missatge és de la forma <i>MissatgeExcepció | MétodeCausantExcepció</i> i és la pròpia classe de l'excepció qui tracta convenientment aquesta cadena, no pas la classe PDAProperties.<br/>
 ...
 * Aquesta classe és filla de java.util.Hashtable, d'aqui l'atribut <i>properties</i> de tipus Hashtable, que permet guardar valors i accedir-los mitjançant una clau.
...
public class PDAProperties{
	...
	static
	{
		 ...
		 * (ex: properties_es-ES.properties) , sinó agafem el fitxer properties.properties
		 */
	...
	{				
		...
		try
		{
			inputstream = Object.class.getResourceAsStream("/edu/upc/lsdatalib/utilsfitxer/"+filename);
